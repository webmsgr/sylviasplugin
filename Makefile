...
update-translations:
	pybabel extract -F babel.cfg -k lazy_gettext -o slyv/translations/messages.pot .
	pybabel update -i slyv/translations/messages.pot -d slyv/translations/

add-translation:
	@read -p "Enter new language shortcode:" lang; \
	pybabel init -i slyv/translations/messages.pot -d slyv/translations/ -l $$lang

compile-translations:
	pybabel compile -d slyv/translations/
